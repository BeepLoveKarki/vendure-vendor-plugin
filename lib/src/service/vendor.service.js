...
let VendorService = class VendorService {
    ...
    async getVendorById(ctx, data) {
        return this.connection.getEntityOrThrow(ctx, vendor_entity_1.VendorEntity, data);
    }
    ...
    async updateSingleVendor(ctx, data) {
        ...
        return this.connection.getEntityOrThrow(ctx, vendor_entity_1.VendorEntity, data.id);
    }
    async deleteSingleVendor(ctx, ids) {
        const Variants = await this.connection.getEntityOrThrow(ctx, vendor_entity_1.VendorEntity, ids);
